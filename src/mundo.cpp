...
void mundo::mueve()
{
	...
	if (posxf == alfilb1.getx() && posyf == alfilb1.gety()) {
		...
		if (posxfinf > posxf && posyfin > posyf) {
			do {
	...
	else  //(alfilb1.getturno() == 0 && alfilb2.getturno() == 0 && caballob1.getturno() == 0 && caballob2.getturno() == 0 && torreb1.getturno() == 0 && torreb2.getturno() == 0 && reyb.getturno() == 0 && reinab.getturno() == 0 && listapeonn.getturno() == 0)
	{
...
int mundo::final()
{
	if ((reyn.getx() == 10 && reyn.gety() == 3) || (reyb.getx() == 10 && reyb.gety() == 8))
		return 1;
	else return 0;
